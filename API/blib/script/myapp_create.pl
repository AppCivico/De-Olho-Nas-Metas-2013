...
Catalyst::ScriptRunner->run('SMM', 'Create');
...
myapp_create.pl [options] model|view|controller name [helper] [options]
 ...
 Examples:
   ...
   myapp_create.pl model SomeDB DBIC::Schema SMM::Schema create=dynamic\
   dbi:SQLite:/tmp/my.db
   myapp_create.pl model AnotherDB DBIC::Schema SMM::Schema create=static\
