...
sub feature {
    ...
    push @$features,
      ( $name =>
          [ map { ref($_) ? ( ref($_) eq 'HASH' ) ? %$_ : @$_ : $_ } @$mods ] );
...
sub __extract_license {
    ...
    my @phrases = (
        ...
        1,
        'Artistic license 2\.0' => 'artistic_2',
        1,
        'LGPL' => 'lgpl',
        1,
        'MIT' => 'mit',
...
## from Software-License
        'The GNU Affero General Public License, Version 3, November 2007' =>
          'open_source',
        1,
        'The Apache Software License, Version 1.1' => 'apache',
        1,
        'The Apache License, Version 2.0, January 2004' => 'apache',
        1,
        'The Artistic License 1.0' => 'artistic',
        1,
        'The Artistic License 2.0 (GPL Compatible)' => 'artistic_2',
        1,
        'The (three-clause) BSD License' => 'bsd',
        1,
        'CC0 License' => 'unrestricted',
        1,
        'The (two-clause) FreeBSD License' => 'open_source',
        1,
        'GNU Free Documentation License v1.2' => 'open_source',
        1,
        'GNU Free Documentation License v1.3' => 'open_source',
        1,
        'The GNU General Public License, Version 1, February 1989' => 'gpl',
        1,
        'The GNU General Public License, Version 2, June 1991' => 'gpl',
        1,
        'The GNU General Public License, Version 3, June 2007' => 'gpl',
        1,
        'The GNU Lesser General Public License, Version 2.1, February 1999' =>
          'lgpl',
        1,
        'The GNU Lesser General Public License, Version 3, June 2007' => 'lgpl',
        1,
        'The MIT (X11) License' => 'mit',
        1,
        'The Mozilla Public License 1.0' => 'mozilla',
        1,
        'The Mozilla Public License 1.1' => 'mozilla',
        1,
        'Mozilla Public License Version 2.0' => 'mozilla',
        1,
        '"No License" License' => 'restrictive',
        1,
        'OpenSSL License' => 'open_source',
        1,
        'the same terms as the perl 5 programming language system itself' =>
          'perl',
        1,
        'The PostgreSQL License' => 'open_source',
        1,
        'The Q Public License, Version 1.0' => 'open_source',
        1,
        'Original SSLeay License' => 'unrestricted',
        1,
        'Sun Internet Standards Source License (SISSL)' => 'open_source',
        1,
        'The zlib License' => 'open_source',
        1,
    );
