...
sub project_map_single_GET {
    ...
    $api->stash_result( $c, 'projects/geom', params => { project_id => $id }, );
...
sub getregions_GET {
    ...
    $api->stash_result( $c, ['regions/regions_map'], stash => 'region_obj', );
...
sub subpref_org_GET {
    ...
    $api->stash_result( $c, [ 'organizations', $id ], stash => 'org_obj', );
