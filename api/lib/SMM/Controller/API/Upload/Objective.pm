...
package SMM::Controller::API::Upload::Objective;
...
sub configuration : Chained('base') : PathPart('objectives') : Args(0)
  : ActionClass('REST') {
...
sub configuration_POST {
    ...
    my %header = ( name => qr /\bnome\b/io, );
    $c->stash->{db}       = $c->model('DB::Objective');
